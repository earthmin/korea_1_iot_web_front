...
while (조건식) {
  ...
  >> 표현식의 결과가 조건식의 flase(거짓)에 도달할 수 있도록
...
console.log('== while 반복문 예제 ==');
let b = 0; // 초기화식의 분리 

while (b < 5) { // 조건식
  //표현식을 조건식에 도달할 기분이 없음 : 무한 루프
  console.log(b);
...
console.log('== do-while문 예제 ==');

let c = 0;
do {
  // 실행 블록 내에 초기화식 작성의 경우
  // : 반복할 때마다 초기화되어 무란 루프와 동일

  console.log(c);
  c += 1;
} while (c < 5);

console.log('===방복문 / 조건문 활용 예제');
