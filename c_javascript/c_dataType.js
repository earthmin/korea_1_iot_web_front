...
console.log (
  //vlaue 변수의 타입이 'object' 이면서(and) 값이 존재하지 않을 경우 'null'을 출력
  // , 그것이 아니라면 'not null' 을 출력 
    (typeof  value === 'object' && !value) ? 'null' : 'not null' //null
);

// 4-2. undifined : 정의되지 않았다. 
// >> 변수가 선언되었으나, 아직 어떠한 값도 할당되지 않았을때의 기본값 

let hello; // 변수선언
//clg -> console.log 스니펫 단축어
console.log(hello);
...
//3. Bolean() 함수
//true : 밑에 값을 제외한 모든 데이터를 true로 간주
//false :flase, 0, '', null, nudafiend, NaN 
