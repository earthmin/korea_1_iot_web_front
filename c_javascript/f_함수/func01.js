...
// 모듈성 
// : 로직(코드 흐름) 단위로 작업을 나누어 관리 할 수 있는 특성 
...
//# 3. 화살표 함수 
// : 기존의 function 키워드를 화살표(=>)로 댜채하여 간경한 함수를 작성 
// : 항상 익명 함수로 사용
...
//? 화살표 함수는 함수 본문(기능 구현부)이 단일문인 경우 
//? 중괄호와 return 키워드 생략이 가능 
